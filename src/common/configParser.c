...
void setPattern(char **destination, char *line, const char *pattern) {
    if (strlen(line) < strlen(pattern) + 4)
        return;
...
void parseLine(PtShConfig *config, char *line) {
    ...
    setPattern(&config->filePrefixEscapeCodes, line,
               "FILE_PREFIX_ESCAPE_CODES");
    setPattern(&config->linkPrefixEscapeCodes, line,
               "LINK_PREFIX_ESCAPE_CODES");
    ...
    setPattern(&config->errorPrefixEscapeCodes, line,
               "ERROR_PREFIX_ESCAPE_CODES");
    setPattern(&config->errorMessageEscapeCodes, line,
               "ERROR_MESSAGE_ESCAPE_CODES");
    setPattern(&config->successPrefixEscapeCodes, line,
               "SUCCESS_PREFIX_ESCAPE_CODES");
    setPattern(&config->successMessageEscapeCodes, line,
               "SUCCESS_MESSAGE_ESCAPE_CODES");
    setPattern(&config->pwdDirSeparator, line, "PWD_DIR_SEPARATOR");
    setPattern(&config->pwdDirSeparatorEscapeCodes, line,
               "PWD_DIR_SEPARATOR_ESCAPE_CODES");
    ...
    setPattern(&config->cpProgressBarBorderEscapeCodes, line,
               "CP_PROGRESSBAR_BORDER_ESCAPE_CODES");
    setPattern(&config->cpProgressBarEscapeCodes, line,
               "CP_PROGRESSBAR_ESCAPE_CODES");
}
